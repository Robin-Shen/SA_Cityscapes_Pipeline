...
if __name__ == "__main__":
    ...
    if not os.path.isdir("./experiments_eccv/prob_heur_4000_modi/"):
        os.mkdir("./experiments_eccv/prob_heur_4000_modi")
    ...
    try:
        for filename, image, sseg, inst, scribbles in data_generator:
            ...
            # skip existed gt
            if os.path.isfile("./experiments_eccv/prob_heur_4000_modi/" + filename + "_gtFine_instanceIds.png"):
            ...
            # save annotation
            Image.fromarray(sseg_pred).save("./experiments_eccv/prob_heur_4000_modi/"  + filename + "_gtFine_labelIds.png")
            Image.fromarray(inst_pred).save("./experiments_eccv/prob_heur_4000_modi/" + filename + "_gtFine_instanceIds.png")
            cv2.imwrite("./experiments_eccv/prob_heur_4000_modi/" + filename + "_gtFine_color.png", mask)
