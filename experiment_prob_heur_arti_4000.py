...
if __name__ == "__main__":
    ...
    try:
        for filename, image, sseg, inst, scribbles in data_generator:
            ...
            # skip existed gt
            if os.path.isfile("./experiments_eccv/prob_heur_arti_4000/" + filename + "_gtFine_instanceIds.png"):
            ...
            # save annotation
            Image.fromarray(sseg_pred).save("./experiments_eccv/prob_heur_arti_4000/"  + filename + "_gtFine_labelIds.png")
            Image.fromarray(inst_pred).save("./experiments_eccv/prob_heur_arti_4000/" + filename + "_gtFine_instanceIds.png")
            cv2.imwrite("./experiments_eccv/prob_heur_arti_4000/" + filename + "_gtFine_color.png", mask)
